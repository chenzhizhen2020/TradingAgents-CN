...
class BatchAnalysisRequest(BaseModel):
    ...
    title: str = Field(..., description="批次标题")
    description: Optional[str] = None
    symbols: Optional[List[str]] = Field(None, min_length=1, description="股票代码列表")
    stock_codes: Optional[List[str]] = Field(None, min_length=1, description="股票代码列表(已废弃,使用symbols)")
    parameters: Optional[AnalysisParameters] = None
